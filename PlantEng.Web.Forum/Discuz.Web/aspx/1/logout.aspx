        ...
        if (infloat != 1)
        {
            ...
            if (userid == -1)
            {
                ...
                if (pagename != "login.aspx" && pagename != "register.aspx")
                {
                    ...
                    templateBuilder.Append("<div class=\"fastlg c1\">\r\n					<div class=\"y pns\">\r\n						<p><a href=\"" + config.CommonLoginUrl + currentPageUrl + "\">登录</a>&nbsp;&nbsp;<a href=\"" + config.CommonRegisterUrl + currentPageUrl + "\">注册</a></p>\r\n					</div>\r\n				</div>\r\n            ");
                }	//end if
            ...
            else
            {
                ...
                templateBuilder.Append("\r\n			<p class=\"reg_tip\">\r\n				<a href=\"");
                templateBuilder.Append(config.CommonLoginUrl + currentPageUrl);
