                    ...
                    if (attachmentlist.Count > 0)
                    {
                        ...
                        if (currentattachcount > 0)
                        {
                                    ...
                                    if (attachment.Pid == post.Pid)
                                    {
                                        ...
                                        if (attachment.Allowread == 1)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                templateBuilder.Append("\r\n	<div class=\"hide\">\r\n	   附件:<em><span class=\"attachnotdown\">您需要登录才可以下载或查看附件。</span></em>\r\n	</div>    \r\n");
                                            }	//end if
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                templateBuilder.Append("\r\n							<div class=\"hide\">附件: <em><span class=\"attachnotdown\">你需要登录才可以下载或查看附件。</span></em></div>\r\n							");
                                            }	//end if
                            ...
                            else
                            {
                                ...
                                templateBuilder.Append("\r\n					    <div class=\"hide\">附件:<em><span class=\"attachnotdown\">您需要登录才可以下载或查看附件。</span></em></div>\r\n						");
                            }	//end if
                ...
                if (config.Fastpost == 2 || config.Fastpost == 3)
                {
                    ...
                    if ((topic.Closed != 1 || ismoder == 1) && (userid < 0 || canreply))
                    {
                        ...
                        else
                        {
                            ...
                            templateBuilder.Append("\r\n					<div class=\"hm p_login cl\">你需要登录后才可以发帖</div>\r\n					");
                        }	//end if
